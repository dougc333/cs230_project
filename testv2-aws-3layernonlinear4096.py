...
W2V_PATH = "/home/ubuntu/cs230_project/dataset/GloVe/glove.840B.300d.txt"
...
# paths
parser.add_argument("--nlipath", type=str, default='/home/ubuntu/InferSent/dataset/SNLI', help="NLI data path (SNLI or MultiNLI)")
parser.add_argument("--outputdir", type=str, default='savedir/', help="Output directory")
parser.add_argument("--outputmodelname", type=str, default='3layernonlinear4096.pickle')
...
parser.add_argument("--dpout_fc", type=float, default=0.0, help="classifier dropout")
...
parser.add_argument("--enc_lstm_dim", type=int, default=4096, help="encoder nhid dimension")
...
parser.add_argument("--data_dir", type=str, default='/home/ubuntu/cs230_project/dataset', help="store duplicate questions")
...
#data formatting
QUORA_PATH="/home/ubuntu/cs230_project/dataset"
...
torch.save(nli_net.state_dict,os.path.join(params.outputdir, params.outputmodelname + "3layernonlinear_fullmodel.pt"))
