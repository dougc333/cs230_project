...
parser.add_argument("--outputmodelname", type=str, default='3layernonlinear_dropout5.pickle')
...
torch.save(nli_net.state_dict,os.path.join(params.outputdir, params.outputmodelname + "3layernonlinear_dropout5_fullmodel.pt"))
